                        ...
                        <form role="form" id="order-form" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <button class="btn btn-danger" id="display:none;" id="btn-cancel-coupon">取消</button>
                                </div>
                            </div>
                            <!-- 优惠码结束 -->
...
<script>
    $(document).ready(function() {
       ...
       $('.btn-create-order').click(function() {
           ...
           // 遍历<table>标签内所有带有 data-id 属性的 tr 标签，也就是每一个购物车中的商品sku
           ...
           axios.post('{{ route('orders.store') }}', req)
               .then(function(response) {
                   swal('订单提交成功', '', 'success')
                       .then(() => location.href = '/orders/' + response.data.id);
               }, function(error) {
